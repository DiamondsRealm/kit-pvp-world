...
tellraw @s {"text":" "}
tellraw @s [{"text":"[","color":"dark_gray","bold":true},{"text":"KitPvP","color":"gold","bold":true},{"text":"] ","color":"dark_gray","bold":true},{"text":"You have not reached the ","color":"yellow","bold":false},{"text":"Mercenary ","color":"dark_green","bold":false},{"text":"rank yet.","color":"yellow","bold":false}]
